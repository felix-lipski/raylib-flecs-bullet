...
public:
    ...
    Fizyk() : temp_allocator(10 * 1024 * 1024), job_system(cMaxPhysicsJobs, cMaxPhysicsBarriers, thread::hardware_concurrency() - 1) {
	    ...
	    /* this->temp_allocator = TempAllocatorImpl(10 * 1024 * 1024); */
	    /* JobSystemThreadPool job_system(cMaxPhysicsJobs, cMaxPhysicsBarriers, thread::hardware_concurrency() - 1); */
        /* this->temp_allocator = TempAllocator(); // Initialize TempAllocator */
        /* this->job_system = JobSystem();         // Initialize JobSystem */
...
int main(int argc, char** argv) {
	...
	/* PhysicsSystem * physics_system = initPhysics(); */
	...
	/* PhysicsSystem * ps = initPhysics(); */
	/* PhysicsSystem physics_system = p[0]; */
	/* PhysicsSystem physics_system = *initPhysics(); */


	MyBodyActivationListener body_activation_listener;
	/* physics_system.SetBodyActivationListener(&body_activation_listener); */
	f->physics_system.SetBodyActivationListener(&body_activation_listener);
	MyContactListener contact_listener;
	/* physics_system.SetContactListener(&contact_listener); */
	f->physics_system.SetContactListener(&contact_listener);
	...
	f->physics_system.OptimizeBroadPhase();
	...
	while (body_interface.IsActive(sphere_id))
	{
		...
		// Step the world
		/* f->physics_system.Update(cDeltaTime, cCollisionSteps, &temp_allocator, &job_system); */
		f->update();
	}
